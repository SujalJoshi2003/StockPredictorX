...
def renderTabSuggestions():
    ...
    if ( avgScore > 0.5 ):
        ...
        st.write("It seems the sentiment is negative accorind to the recent news. Based on this, we suggest you reconsider your decision or look for other options to meet your needs")
